        ...
        <>
            <div className="container w-3/5 min-h-screen flex items-center justify-start mx-auto">
                <div className="text-left">
                    ...
                    <h1 className="bg-gradient-to-r from-[color:var(--clr-gradient-text)] to-[color:var(--clr-gradient-text-secondary)] bg-clip-text text-transparent text-[55px] leading-normal xs:text-5xl xs:leading-tight font-bold">{HeroProps.intro}</h1>
